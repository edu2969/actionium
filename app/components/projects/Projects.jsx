...
export default function Projects() {
    ...
    const nombreEstado = (valor) => {
        return Object.keys(PROJECT_STATUS).find(key => PROJECT_STATUS[key] === valor)?.toUpperCase();
    }

    const projectTypeLabel = (valor) => {
        return Object.keys(PROJECT_TYPE).find(key => PROJECT_TYPE[key] === valor)?.toUpperCase();
    }
